...
# 分段阈值（像素差比例）
NORMAL_THRESHOLD = 0.0000002  # 2% 以内为正对
...
#最终通过 calculate_filtered_average 函数计算平滑后的结果，避免单次测量的偶然误差影响最终结果
...
def process_frame(frame):
    ...
    global outer_height_history  # 新增：测距历史
